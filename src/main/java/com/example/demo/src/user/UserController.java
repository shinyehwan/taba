...
public class UserController {
    ...
    @ResponseBody
    @GetMapping("/{userIdx}")
    public BaseResponse<List<GetUserMyPageRes>> getCompanyInfo(
        ...
        try {
            ...
            List<GetUserMyPageRes> getUserMyPageRes = userService.getCompany(userIdx);
            return new BaseResponse<>(getUserMyPageRes);
        } catch (BaseException exception) {
            return new BaseResponse<>((exception.getStatus()));
        }
